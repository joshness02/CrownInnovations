app.controller("ProductController", ['$scope', function ($scope) {
    $scope.products = [

        {
            ...
            imgs: ["../../imgs/StationaryFencePicture.png"],
        ...
        },
        {
            ...
            imgs: ["../../imgs/StationaryWrapAroundPicture.png"],
        ...
        },
        {
            ...
            imgs: ["../../imgs/MobilePicture.png"],
            description: "Great for one-on-one time with your bottle calves",
            about: "The Mobile Calf Pacifier is great for when you are spending time with your calf. Whether you are trying to keep him occupied while you feed other calves, or just having fun with him, the Mobile Calf Pacifier is here to help. If the Pacifier is dropped on the ground, it will automatically right itself using our Patented Pop-Up design, keeping the Pacifier clean.",
        },
    ];
}]);
